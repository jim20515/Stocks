  ...
  <div class="min-h-screen bg-slate-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-sm p-8">
      ...
      <div class="mt-6 pt-5 border-t border-slate-100 text-center">
        <p class="text-xs text-slate-400 mb-1.5">有問題或建議？加入 LINE 社群</p>
        <a href="https://tinyurl.com/25kjcu5g" target="_blank" rel="noopener"
          class="inline-flex items-center gap-1.5 text-xs font-medium text-green-600 hover:text-green-700 transition">
